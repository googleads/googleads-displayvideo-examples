...
"""This example creates a HTML5 creative."""
...
def main(service, flags):
    """Creates a new DV360 HTML5 creative.
    ...
    # Upload html asset
    html5_asset = upload_creative_asset(
        service, advertiser_id, flags.html_asset_path
    )
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "html_asset_path",
        help="The path to the file being uploaded and assigned as a html "
        "asset.",
    )
    argparser.add_argument(

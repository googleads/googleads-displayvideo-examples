...
import com.google.api.services.displayvideo.v2.DisplayVideo.Sdfdownloadtasks;
...
import com.google.api.services.displayvideo.v2.model.ParentEntityFilter;
...
public class DownloadStructuredDataFiles {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (!params.parseArguments(args)) {
      ...
      List<Long> filterIdsTmp = new ArrayList<Long>();

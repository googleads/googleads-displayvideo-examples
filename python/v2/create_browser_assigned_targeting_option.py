...
The targeting type of the assigned targeting option in this example is TARGETING_TYPE_BROWSER.
"""
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        help="The targeting option id representing the browser to be "
        "targeted.",
    )

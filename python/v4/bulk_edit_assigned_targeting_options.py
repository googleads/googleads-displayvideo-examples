...
import samples_util
from v4_util import print_bulk_edit_targeting_response
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "line_item_id",
        help="The ID of the line item to which the listed targeting options are"
        "assigned.",
    )
    argparser.add_argument(
        ...
        "item. Multiple values can be listed after declaring the argument. Ex: "
        '"--browser_del_targeting_ops 10001 10002 10003"',
    )
    argparser.add_argument(
        "--device_make_model_del_targeting_ops",
        nargs="+",
        help="The device type assigned targeting options to delete from the "
        "line item. Multiple values can be listed after declaring the argument."
        ' Ex: "--device_del_targeting_ops 10001 10002 10003"',
    )
    argparser.add_argument(

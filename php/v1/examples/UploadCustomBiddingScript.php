...
class UploadCustomBiddingScript extends BaseExample
{
    ...
    public function run()
    {
        ...
        printf(
            '<p>The script will be uploaded to the following resource path: %s</p>',
        ...
        try {
            // Call the API, creating the custom bidding script using the script file and under
            // the advertiser and custom bidding algorithm given.

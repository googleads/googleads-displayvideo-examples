...
order. If generating a Mobile App Install line item, an app ID must be
provided.
"""
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "--app_id",
        help="The app ID of the mobile app promoted by the line item. "
        "Required and only valid if line item type is either "

...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        "line_item_id",
        help="The ID of the line item whose audience targeting option will "
        "be updated.",
    )
    argparser.add_argument(
        ...
        "targeting. Multiple values can be listed after declaring the "
        'argument. Ex: "--additional_google_audiences 10001 10002 10003"',
        required=True,
    )

...
class DownloadStructuredDataFiles extends BaseExample
{
     ...
     * @param string $filterType a FilterType enum value specifying the
     *     resource type by which the content of the SDFs will be filtered by.
     * @param array $filterIds an array of resource IDs of the type specified
     *     in filterType parameter. If the filterType parameter is
     *     FILTER_TYPE_NONE, than this array can be empty.
     * @return Google_Service_DisplayVideo_Operation the created
     *     SdfDownloadTask
     */
                ...
                if($operation->getError() !== null) {
                    ...
                    printf(
                        'The operation completed successfully. Resource %s '
                            . 'was created. Ready to download.<br>',

...
import com.google.api.services.displayvideo.v2.model.BrowserAssignedTargetingOptionDetails;
...
public class BulkEditAssignedTargetingOptions {
  ...
  public static void runExample(
    ...
    List<AssignedTargetingOption> createBrowserAssignedTargetingOptions =
    ...
    if (response.getErrors() != null && !response.getErrors().isEmpty()) {
      System.out.printf("The following errors were thrown when attempting to edit the targeting:");

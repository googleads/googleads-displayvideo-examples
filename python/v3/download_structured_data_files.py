...
def main(service, flags):
    ...
    print(
        f"The operation completed successfully. Resource {resource_name} was "
        "created."
    )
...
if __name__ == "__main__":
    ...
    group.add_argument(
        "--partner_id",
        help="The ID of the partner for which to download the SDF. Required if "
        "the --advertiser_id argument is not set.",
    )
    group.add_argument(
        "--advertiser_id",
        help="The ID of the advertiser for which to download the SDF. Required "
        "if the --partner_id argument is not set.",
    )
    ...
    argparser.add_argument(
        "filter_type",
        help="The type of resource by which to filter the data included in the "
        "generated SDFs.",
    )
    argparser.add_argument(
        "--file_types",
    ...
    argparser.add_argument(
        "--filter_ids",
        nargs="+",
        help="The IDs of the resources by which to filter the data included in "
        "the generated SDFs. Multiple values can be listed after declaring the "
        'argument. Ex: "--filter_ids 10001 10002 10003"',
    )

...
import com.google.api.services.displayvideo.v2.DisplayVideo.Users;
import com.google.api.services.displayvideo.v2.DisplayVideoScopes;
import com.google.api.services.displayvideo.v2.model.AssignedUserRole;
...
public class EditUserAccess {
  ...
  public static void runExample(
    ...
    List<AssignedUserRole> addedUserRoles = new ArrayList<AssignedUserRole>();
    ...
    List<String> deletedResourceIds = new ArrayList<String>();

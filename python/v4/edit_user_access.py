...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        ...
        "appropriate access to the partner. Multiple instances of this argument"
        ' may be included in the command. Ex: "--add_partner_role 123 '
        'ADMIN"',
    )
    argparser.add_argument(
        "--add_advertiser_role",
        nargs=2,
        action="append",
        help="An advertiser ID and user role to assign to the user to grant the"
        " appropriate access to the advertiser. Multiple instances of this "
